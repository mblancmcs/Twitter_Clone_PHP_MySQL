	    	...
	    	<div class="col-md-4">
				...
				<form method="post" action="registra_usuario.php" id="formCadastrarse">
					<div class="form-group">
						...
						<?php
							if($erro_usuario){ // 1 ou 0 (o php também entende como verdadeiro ou falso), porém pode-se usar o == 1 ou 0
					...
					<div class="form-group">
						...
						<?php
							if($erro_email){ // 1 ou 0 (o php também entende como verdadeiro ou falso), porém pode-se usar o == 1 ou 0
